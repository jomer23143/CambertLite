...
namespace Cambert
{
    public static class UIControlSupport
    {
        public static ComboBoxEx SetComboBoxEx(ComboBoxEx cbo, DataTable  dt, String DropDownColumns, String DisplayMember,
                                               String ValueMember, AutoCompleteSource AutoSource, AutoCompleteMode AutoMode, 
                                               ComboBoxStyle DropStyle, Int32 DropDownWidth, Int32 DropDownHeight)
        {
            cbo.DataSource = dt;
            ...
            cbo.DropDownWidth = DropDownWidth;
            cbo.DropDownHeight = DropDownHeight;
            return cbo;
        }
