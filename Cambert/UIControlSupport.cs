...
public static class UIControlSupport
{
    public static ComboBoxEx SetComboBoxEx(ComboBoxEx cbo, DataTable  dt, String DropDownColumns, String DisplayMember,
                                           String ValueMember, AutoCompleteSource AutoSource, AutoCompleteMode  AutoMode, ComboBoxStyle DropStyle,Int32 dropdownWidth,Int32 dropDownHeight)
    {
        cbo.DataSource = dt;
        ...
        cbo.DropDownHeight = dropdownWidth;
        cbo.DropDownWidth = dropDownHeight;
        return cbo;
    }
