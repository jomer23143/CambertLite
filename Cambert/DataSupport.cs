    ...
    public class DataSupport : IDisposable
    {
        ...
        public String ConnectionString 
        {
            get {
                ...
                if (connectString == "")
                    //result = new StreamReader( File.OpenRead("connection_string.txt")).ReadToEnd();
                    result = "Initial Catalog=" + Utils.DBConnection["CAMBERT"]["DBNAME"] + ";Data Source=" + Utils.DBConnection["CAMBERT"]["SERVER"] + ";User Id = " + Utils.DBConnection["CAMBERT"]["USERNAME"] + "; Password = " + Utils.DBConnection["CAMBERT"]["PASSWORD"];
                else
